...
// @note These are the core Yearn libraries
...
contract Strategy is BaseStrategy {
    ...
    constructor(address _vault) public BaseStrategy(_vault) {
        // @dev You can set these parameters on deployment to whatever you want
        // minReportDelay = 6300;
        // profitFactor = 100;
        // debtThreshold = 0;
    }
    ...
    function prepareReturn(uint256 _debtOutstanding) internal override returns (uint256 _profit) {
        ...
        // @note OTE: Should try to free up at least `_debtOutstanding` of underlying position
    }

    /* 
     * @dev Perform any adjustments to the core position(s) of this strategy given
